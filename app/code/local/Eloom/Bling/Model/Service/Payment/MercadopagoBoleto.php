...
class Eloom_Bling_Model_Service_Payment_MercadopagoBoleto extends Mage_Core_Model_Abstract {
	...
	public function prepare($orderId) {
		...
		$days = 1;
		$days = $days + Eloom_Bling_Model_Service_Payment_Proxy::BOLETO_DAYS;
